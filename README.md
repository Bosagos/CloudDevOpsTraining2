...
This is a Node and Express web application used to demonstrate CI/CD with Azure DevOps. You can clone this repo and use it within Azure DevOps to build, test, and release to an Azure App Service web app. testing stuffs

[![Build Status](https://dev.azure.com/ProjectPacific/test-node-express-demo/_apis/build/status/sammadu1.node-express-azure?branchName=master)](https://dev.azure.com/ProjectPacific/test-node-express-demo/_build/latest?definitionId=7&branchName=master)
